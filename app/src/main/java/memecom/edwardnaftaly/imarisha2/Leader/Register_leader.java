...
public class Register_leader extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bregister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Register_leader.this,Report_case.class);
                startActivity(i);
            }
        });
        ...
        bregister_signin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Register_leader.this,Register_leader.class);
                startActivity(i);
            }
        });
    }

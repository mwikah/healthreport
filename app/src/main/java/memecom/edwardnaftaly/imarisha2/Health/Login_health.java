...
public class Login_health extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        bregister.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent i = new Intent(Login_health.this,Healthworker_report.class);
                startActivity(i);
            }
        });
        ...
        bregister_signin.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent i = new Intent(Login_health.this,Register_health.class);
                startActivity(i);
            }
        });
    }
